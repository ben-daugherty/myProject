...
var buttonClick = document.getElementById('item');
...
//Enter functionality
buttonClick.onkeypress = function() {pressFunction()};

function pressFunction() {
  buttonClick.style.backgroundColor = '#ddf0fb';

};

buttonClick.addEventListener('keydown', function(e) {
  var value = this.value;
  if (e.code === 'Enter' && value) {
    addItemTodo(value);
    document.getElementById('item').value = '';
    buttonClick.style.backgroundColor = '#b5d7ecb3';
}
});
